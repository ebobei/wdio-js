...
class MainPage {
    get buttonSaleFromHeader() {return $('//*[@data-name="Скидки"]');}

    get saleTitle() {return $('//*[@class="col-12"]//h1');}

    get buttonStockFromHeader() {return $('//*[@data-name="Акции"]');}

    get buttonAllArticles() {return $('//a[contains(text(),"Все статьи")]');}
    ...
    get orderStatusTitle() {return $('//*[@class="order-check--title"]');}

    get orderStatusNum() {return $('//*[@class="status-page__title"]');}

    get productOfTheDayTitle() {return $('//*[ .="Товары дня"]');}

    get productsOfTheDayCollection() {return $$('//*[@aria-hidden="false"]//*[@data-test-id="productOfTheDay"]');}
    ...
    get wowSaleBanner() {return $('//*[@alt="Вау-скидки"]');}
    ...
    get bannersBlock() {return $('//*[@class="banners-puzzle"]');}
    ...
    getOrderStatusNum() {
        AllureReporter.addStep('Проверка заголовка раздела "Что с моим заказом"');
        this.orderStatusNum.waitForDisplayed({
            timeout: 20000,
            timeoutMsg: 'Заголовок раздела "Что с моим заказом" не отображается!'
        });
        return this.orderStatusNum.getAttribute('data-order-number');
    }
    ...
    clickButtonStockFromHeader() {
        ...
        this.buttonStockFromHeader.waitForDisplayed({
            timeout: 15000,
            timeoutMsg: 'Кнопка "Акции" в хэдере не отображается!'
        });
    ...
    clickButtonSaleFromHeader() {
        ...
        this.buttonSaleFromHeader.waitForDisplayed({
            timeout: 10000,
            timeoutMsg: 'Кнопка "Скидки" в хэдере не отображается!'
        });
    ...
    clickButtonAllArticles() {
        ...
        this.buttonAllArticles.scrollIntoView();
        this.buttonAllArticles.waitForDisplayed({
            timeout: 30000,
            timeoutMsg: 'Кнопка "Все статьи" недоступна для клика!'
        });
        browser.execute("arguments[0].click();", this.buttonAllArticles);
    }
