...
exports.config = {
    ...
    suites: {
        prod_offer: [
            './test/specs/offer.orders/prod/prod.offer.orders.test.js'
        ],

        release_offer: [
            './test/specs/offer.orders/release/release.offer.orders.test.js'
        ],

        stage_offer: [
            './test/specs/offer.orders/stage/stage.offer.orders.test.js'
        ],

        cancel_orders: [
            './test/specs/offer.orders/cancel.orders.test.js'
        ]
    },
